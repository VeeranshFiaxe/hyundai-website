...
const title = "Contact Us | Modi Hyundai Mumbai, Thane, Vasai & Virar";
const description =
  "Get in touch with Modi Hyundai. Call, WhatsApp or visit one of our showrooms and service centres across Mumbai, Thane, Vasai, Virar and Wada.";
          ...
          <div className="container-px absolute inset-x-0 bottom-10 mx-auto max-w-[1400px]">
            <Reveal>
              ...
              <p className="mt-3 max-w-xl text-sm text-white/80 sm:text-base">
                Call {company.phone}, WhatsApp us, or visit any Modi Hyundai
                showroom or service centre near you.
              </p>
            </Reveal>
          </div>
        </section>
